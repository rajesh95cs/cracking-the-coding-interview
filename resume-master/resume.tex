...
\hline
\textbf{Examination} & \textbf{University or Board} & \textbf{Institute} & \textbf{Year} & \textbf{\%} \\
\hline
UnderGraduate Specialization: & \textit{Computer Engineering} \\
Graduation & M G University, Kottayam & SCMS, Angamaly & 2018-passout & 65\\

\hline
10th & CBSE & Chinmaya Vidyalaya,Tripunitura & 2010-2011 & 80\\
\hline
12th & CBSE & Chinmaya Vidyalaya,Tripunitura & 2011-2013 &
75\\
\end{tabular}
%\end{center}
%\end{table}
...
\begin{itemize}
\item \noindent Software Development, Frontend WEB development .
\end{itemize}

\resheading{\textbf{TECHNICAL SKILLS} }\\[\lsep]
\begin{itemize}
\item \noindent  \textbf{Languages} : Python, C, C++
...
\begin{itemize}
\item \textbf{VOICE COMMAND BROWSING(Extension for Google Chrome Browser)(demo version)
} 
...
\begin{itemize}\itemsep \isep
    ...
    \item This is actually an assignment which was posted at MIT opencourse ware website.
    \end{itemize}
...
\begin{itemize}
\item \noindent Body workout,Solving algorithmic problems in Hackerrank website(current rank 60089).
\end{itemize}
