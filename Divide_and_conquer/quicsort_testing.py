...
def test_mergesort(input,output):
    ...
    print "the execution_time_quicksort() "+str(execution_time_2)
    ...
    print "the execution_time_mergesort() "+str(execution_time_3)
    if collections.Counter(input) == collections.Counter(output):
        print "Test Passed"
    else:
        print "Test Failed"
    ...
    print "the time difference between sort() and quicksort() is ",abs(time_difference_2)

    time_difference_3 = execution_time_2 - execution_time_3
    print "the time difference between mergesort() and quicksort() is ",abs(time_difference_3)
